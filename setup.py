...
setup(
    ...
    scripts=['cmdl_backupu/backupu.py', 'cmdl_backupu/copyu.py', 'cmdl_backupu/infou.py', ],
    entry_points={'console_scripts': ['backupu = cmdl_backupu.backupu:main',
                                      'copyu = cmdl_backupu.copyu:copyu',
                                      'infou = cmdl_backupu.infou:infou']},
    ...
    description='backup, full or inc; copy; get file info work',
