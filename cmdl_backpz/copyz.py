...
def parse_args():
    parser = argparse.ArgumentParser(description='Copy or Move files from SOURCE to DESTINATION',
                                     prog='copyz.py',
    ...
    parser.add_argument('/s', '--source', help='Source dir (one) for copy or move', required=True)
    ...
    parser.add_argument('/w', '--work', help='copy or move', default=actions.WORK_TYPE.copy,
